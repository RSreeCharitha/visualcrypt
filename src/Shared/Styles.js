...
export const color = lightTheme ? 'white' : '#555555';
export const color2 = lightTheme ? 'white' : '#000103';
...
export const subtleBoxShadow = `box-shadow: 0px 0px 5px 1px ${lightTheme ? '#a9b6ff' : '#373a40'}`;
